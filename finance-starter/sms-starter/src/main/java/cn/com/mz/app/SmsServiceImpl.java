...
import cn.com.mz.app.finance.common.utils.RestClientUtils;
...
import static cn.com.mz.app.finance.common.enums.ResponseCode.SYSTEM_ERROR;
    ...
    public SmsSendResponse sendMsg(String phoneNumber, String code) {
        ...
        try {
            ...
            if (response.getStatusCode().is2xxSuccessful()) {
                smsSendResponse.setCode(200);
            }
        } catch (Exception e) {
            logger.error("sendMsg error", e);
            smsSendResponse.setCode(400);
            smsSendResponse.setMessage(SYSTEM_ERROR.name()+":"+StringUtils.substring(e.toString(), 0, 1000));
        }
